...
export interface ReceptionPatient{id:string;patientNumber:string;givenName:string;middleName:string|null;familyName:string;dateOfBirth:string|null;sex?:string|null;phone:string|null;email:string|null;address?:unknown;guardianData?:unknown;status:string;identifiers?:Array<{type:string;value:string;isPrimary:boolean}>}
...
export interface RegisterPatientInput{givenName:string;middleName?:string;familyName:string;dateOfBirth?:string;sex?:string;phone?:string;email?:string;fatherName?:string;address?:unknown;guardianData?:unknown;consentData?:unknown;identifiers?:{type:string;system:string;value:string;isPrimary?:boolean}[]}

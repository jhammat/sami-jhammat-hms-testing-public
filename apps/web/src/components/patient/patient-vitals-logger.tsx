  ...
  return (
    <div className="space-y-6">
        ...
        {Object.entries(SUPPORTED_VITALS).map(([key, def]) => {
          ...
          return (
            <button
              ...
              className={`rounded-2xl px-4 py-2.5 text-xs font-bold transition shadow-xs ${
                isSelected
      ...
      <div className="grid gap-6 lg:grid-cols-12">
        {/* Main Entry Card */}
        <div className="flex flex-col justify-between rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:col-span-7">
        ...
        <div className="flex flex-col rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900 lg:col-span-5">
          ...
          <div className="mt-4 flex-1 divide-y divide-slate-100 overflow-y-auto dark:divide-slate-800">

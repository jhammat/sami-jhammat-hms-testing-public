...
export function AuthFrame({
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_18%_12%,rgba(37,99,235,0.14),transparent_29%),radial-gradient(circle_at_84%_18%,rgba(124,58,237,0.13),transparent_27%),linear-gradient(180deg,#fbfdff,#f4f7ff)]">
      <div className="relative flex min-h-screen w-full items-center justify-center px-4 py-8 sm:px-6 sm:py-10">
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 opacity-[0.28] [background-image:linear-gradient(rgba(99,102,241,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(99,102,241,0.05)_1px,transparent_1px)] [background-size:36px_36px]"
        />

        <svg
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-1/2 h-[520px] w-[120%] min-w-[920px] -translate-x-1/2 -translate-y-1/2 opacity-95"
        ...
        <section className="relative z-[1] w-full max-w-[520px] rounded-[30px] border border-white/90 bg-white/95 p-5 shadow-[0_38px_110px_rgba(30,64,175,0.24)] ring-1 ring-blue-100/80 backdrop-blur-xl sm:p-7 lg:p-8">
          <div
            aria-hidden="true"
          ...
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <span className="mt-2 inline-flex rounded-full border border-blue-100 bg-blue-50/80 px-3 py-1.5 text-[10px] font-bold text-blue-700">
              {productName}
            </span>
          </div>
          ...
          <p className="mt-7 border-t border-slate-100 pt-5 text-center text-[11px] leading-5 text-slate-400">
            Access is limited to authorized users and may be monitored for
